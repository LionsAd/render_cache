...
/**
 * @file
 * Contains \Drupal\render_cache\Tests\Plugin\DefaultPluginManagerTest
 */
...
/**
 * @coversDefaultClass \Drupal\render_cache\Plugin\DefaultPluginManager
 * @group dic
 */
class DefaultPluginManagerTest extends \PHPUnit_Framework_TestCase {
  ...
  public function setUp() {
    ...
    $this->fallbackPluginManager = Mockery::mock('\Drupal\render_cache\Tests\Plugin\TestFallbackPluginManager[getFallbackPluginId]', array($discovery));
  ...
  public function test_construct() {
    $this->assertInstanceOf('\Drupal\render_cache\Plugin\DefaultPluginManager', $this->pluginManager, 'Plugin manager was constructed successfully.');
  }
