 ...
 * @var string[] $head_title_array
 *   An associative array containing the string parts
 ...
 * @var string $scripts
 *   Script tags necessary to load the JavaScript files and settings for the
 *   page.
 * @var string $page_top
 *   Initial markup from any modules that have altered the
 *   page. This variable should always be output first, before all other dynamic
 *   content.
 * @var string $page
 *   The rendered page content.
 * @var string $page_bottom
 *   Final closing markup from any modules that have altered the
